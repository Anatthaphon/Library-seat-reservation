  ...
  return (
    <div className="dashboard-page">
      ...
      <p className="reservation-note">
        หากทำการจองที่นั่งแล้ว สามารถยกเลิกได้ก่อนถึงเวลาที่จะใช้งาน
        <br />
      ...
      <section className="section agreement">
        <h3>ข้อตกลง</h3>
        <p>
          ผู้ใช้สามารถจองที่นั่งล่วงหน้าได้ไม่เกิน 2 วัน
          <br />
          ใช้งานได้สูงสุด 3 ชั่วโมงต่อครั้ง
          <br />
          หากเกินเวลา โปรดจองใหม่
          <br />
